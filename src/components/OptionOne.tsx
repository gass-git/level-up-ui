...
export default function About() {
  ...
  function handleCurrent() {
    playSound();
    current === textArray.length - 1 ? setCurrent(0) : setCurrent(current + 1);
  }

  function iconHandler() {
    return current === textArray.length - 1 ? faAngleDoubleUp : faCaretDown;
  }

  return (
    <section>
      <div className="content">{textArray[current]}</div>
